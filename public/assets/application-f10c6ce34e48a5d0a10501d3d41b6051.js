...
(function() { this.JST || (this.JST = {}); this.JST["game/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<header>\n  <h1>Games</h1>\n</header>\n\n<section class="games-container">\n\n  <ul class="game-tabs group">\n    <li class="open tab active" id="open-tab">\n      <h2>Open Games</h2>\n    </li>\n    <li class="full tab" id="full-tab">\n      <h2>Full Games</h2>\n    </li>\n  </ul>\n\n  <ul class="open games active" id="open-games">\n    ');  openGames.forEach (function(game) { ; __p.push('\n      <li data-id="',  game.id ,'">',  game.str ,'</li>\n    ');  }) ; __p.push('\n  </ul>\n\n  <ul class="full games" id="full-games">\n    ');  fullGames.forEach (function(game) { ; __p.push('\n      <li data-id="',  game.id ,'">',  game.str ,'</li>\n    ');  }) ; __p.push('\n  </ul>\n\n</section>\n\n<figure class="board-container">\n  <canvas\n    class="game-canvas"\n    id="side-canvas"\n    width="300"\n    height="300">\n  </canvas>\n</figure>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["game/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<header>\n  <h1>Battleships</h1>\n</header>\n\n\n<div class="game-container">\n  <header class="user-stub">\n    <p>You are playing against TWEEDLEDUM</p>\n  </header>\n\n  <figure class="board-container">\n    <canvas\n      class="game-canvas"\n      id="main-canvas"\n      width="600"\n      height="600">\n    </canvas>\n  </figure>\n\n  <footer class="notifications">\n    <p class = "notification">It\'s your move, TWEEDLEDEE</p>\n  </footer>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["landing"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h1>Battleships</h1>\n<h3 id="pre-login" class="landing active">\n  Sign in or create a Free account to play\n</h3>\n<h3 id="start"class="landing">\n  Start A New Game\n</h3>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["user/new_session"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="form-container">\n  <form class="nav-form group" id="sign-in-form">\n\n    <input\n      type="text"\n      class="nav-input sign-in"\n      name="user[email]"\n      placeholder="Email">\n\n    <input\n      type="password"\n      class="nav-input sign-in"\n      name="user[password]"\n      placeholder="Password">\n\n    <button class="nav-input sign-in" id="sign-in-button">Sign In</button>\n\n  </form>\n</div>\n\n<div class="form-container">\n  <form class="nav-form group" id="sign-up-form">\n    <input\n      type="text"\n      class="nav-input sign-up"\n      name="user[username]"\n      placeholder="Username">\n\n\n    <input\n      type="text"\n      class="nav-input sign-up"\n      name="user[email]"\n      placeholder="Email">\n\n    <input\n      type="password"\n      class="nav-input sign-up"\n      name="user[password]"\n      placeholder="Password">\n\n    <button class="nav-input sign-up" id="sign-up-button">Sign Up</button>\n\n  </form>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["user/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<p>Logged in as ',  user.escape("username") ,'</p>\n<button id="sign-out-button">Sign Out</button>\n');}return __p.join('');};
}).call(this);
